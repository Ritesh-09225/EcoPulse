...
const FOOD_ACTIONS: SimAction[] = [
  {
    label: 'Zomato Delivery (15km away)',
    description: '+0.8 kg CO₂ added',
    category: 'food',
    co2_kg: 0.8,
    variant: 'emission',
  },
  {
    label: 'Cooked Vegan Meal at Home',
    description: '-1.2 kg CO₂ avoided',
    category: 'food',
    co2_kg: -1.2,
    variant: 'saving',
  },
...
const TRANSIT_ACTIONS: SimAction[] = [
  {
    label: 'Uber Ride (10km)',
    description: '+1.5 kg CO₂ added',
    category: 'transport',
    co2_kg: 1.5,
    variant: 'emission',
  },
  {
    label: 'Public Bus Ride',
    description: '-0.8 kg CO₂ avoided',
    category: 'transport',
    co2_kg: -0.8,
    variant: 'saving',
  },
...
const ENERGY_ACTIONS: SimAction[] = [
  {
    label: 'Air Conditioner on for 4h',
    description: '+1.2 kg CO₂ added',
    category: 'energy',
    co2_kg: 1.2,
    variant: 'emission',
  },
  {
    label: 'Turned off unused electronics',
    description: '-0.3 kg CO₂ avoided',
    category: 'energy',
    co2_kg: -0.3,
    variant: 'saving',
  },
      ...
      <SheetTrigger
        render={
          <Button
            variant="outline"
            size="icon"
            className="fixed bottom-24 right-6 h-12 w-12 rounded-full shadow-lg border-primary/20 bg-background/80 backdrop-blur-md z-50"
          >
      ...
      <SheetContent side="right" className="w-[400px] sm:w-[480px] overflow-y-auto">
        <SheetHeader>
          <SheetTitle className="flex items-center gap-2">
            <Bug className="h-5 w-5" /> Quick Log Panel
          </SheetTitle>
          <SheetDescription>
        ...
        <div className="mt-6 space-y-5">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                <Utensils className="h-4 w-4 text-orange-400" /> Food & Delivery
              </CardTitle>
            </CardHeader>
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                <Car className="h-4 w-4 text-blue-400" /> Transit
              </CardTitle>
            </CardHeader>
            <CardContent className="grid gap-2">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                <Zap className="h-4 w-4 text-yellow-400" /> Energy
              </CardTitle>
            </CardHeader>
            <CardContent className="grid gap-2">
